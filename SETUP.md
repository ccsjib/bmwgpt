...
<img src="docs/setup_screenshots/get_started.png" height="100"> 
...
<img src="docs/setup_screenshots/get_api_key.png" height="100"> 

### 3. Create API Key

Next, click "Create API Key" in the top right corner.

<img src="docs/setup_screenshots/create_api_key.png" height="100"> 

Then, name the key and select the "Default Gemini Project" or create a new one if desired. 

<img src="docs/setup_screenshots/key_info.png" height="100"> 
...
<img src="docs/setup_screenshots/select_key.png" height="100"> 

In the resulting menu, click "Copy key" to automatically save it to your clipboard.

<img src="docs/setup_screenshots/copy_key.png" height="100"> 

On BMWChat, paste the key into the box in the sidebar. 

<img src="docs/setup_screenshots/paste_key.png" height="100"> 
