...
* Model training cross-entropy loss began at ~2.84 and reduced to ~0.66 after 20 epochs. Validation accuracy reached 78.41% Dataset was then adjusted due to false positive BMW recognition. Loss began at ~1.53 and reduced to ~0.74 after 10 epochs. 
